  ...
  function consultarCep(cep) {
    if (!validarCEPFormato(cep)) {
     ...
     let sro = document.getElementById('sro')
       ...
       if (cep.value >= '10000000' && cep.value <= '10999999' || cep.value >= '10000-000' && cep.value <= '10999-999' && cep.value > '11599999' && cep.value < '11700000' || cep.value > '11599-999' && cep.value < '11700-000' && cep.value > '12000000' || cep.value > '12000-000') {
  
        triagem.innerText = 'CAJAMAR' 
        box.style.backgroundColor = '#000'
        box.style.color = '#f4f4f4'
        pCEP.innerText = 'CEP: ' + cepText
        ptriagem.innerText = 'CAJAMAR'
        sro.innerText = 'SRO (07750-974)'
  
       } else if (cep.value < '09999999' || cep.value < '09999-999') {
       ...
       } else if (cep.value > '10999999' && cep.value < '11599999' || cep.value > '10999-999' && cep.value < '11599-999' && cep.value > '11699999' && cep.value < '12000000' || cep.value > '11699-999' && cep.value < '12000-000') {
        triagem.innerText = 'SANTO AMARO (MaQ A)'
        box.style.backgroundColor = '#05c134'
        box.style.color = '#f4f4f4'
        pCEP.innerText = 'CEP: ' + cepText
...
btn.addEventListener('click', function() {
  ...
  if (btn.dataset.valor === "") {
    btn.style.backgroundColor = '#ecf400'
